...
a) $\rho$ = 0.1 and 0.99
b) starting values of $y_{20}$=-1.5 and 1.5
...
all_results <- mapply(gibbs_binormal, rho=c(rep(0.1,8),rep(0.99,8)),
                      init=c(rep(c(rep(-1.5,4),rep(1.5,4)),2)),
                      n_sim=c(rep(c(200,500,5000,10000),4)))

last_100 <- lapply(all_results, tail, n=100)

means <- lapply(last_100, mean)
r_means <- lapply(means, round, digits=4)
sds <- lapply(last_100, sd)
r_sds <- lapply(sds, round, digits=4)
...
|-------------|-----|------------------|---------------|-------------|-------------|-------------|
| 200 | 0.1 | -1.5 | `r r_means[[1]]` | `r r_sds[[1]]` |`r 0.1*-1.5`|`r (1-.1^2)`|
| 500 | 0.1 | -1.5 | `r r_means[[3]]` | `r r_sds[[3]]` |`r 0.1*-1.5`|`r (1-.1^2)`|
| 5000 | 0.1 | -1.5 | `r r_means[[5]]` | `r r_sds[[5]]`|`r 0.1*-1.5`|`r (1-.1^2)`|
| 10000 | 0.1 | -1.5 | `r r_means[[7]]` | `r r_sds[[7]]` |`r 0.1*-1.5`|`r (1-.1^2)`|
| 200 | 0.1 | 1.5 | `r r_means[[9]]` | `r r_sds[[9]]` |`r 0.1*1.5`|`r (1-.1^2)`|
| 500 | 0.1 | 1.5 | `r r_means[[11]]` | `r r_sds[[11]]` |`r 0.1*1.5`|`r (1-.1^2)`|
| 5000 | 0.1 | 1.5 | `r r_means[[13]]` | `r r_sds[[13]]` |`r 0.1*1.5`|`r (1-.1^2)`|
| 10000 | 0.1 | 1.5 | `r r_means[[15]]` | `r r_sds[[15]]` |`r 0.1*1.5`|`r (1-.1^2)`|
| 200 | 0.99 | -1.5 | `r r_means[[17]]` | `r r_sds[[17]]` |`r 0.99*-1.5`|`r (1-.99^2)`|
| 500 | 0.99 | -1.5 | `r r_means[[19]]` | `r r_sds[[19]]` |`r 0.99*-1.5`|`r (1-.99^2)`|
| 5000 | 0.99 | -1.5 | `r r_means[[21]]` | `r r_sds[[21]]`|`r 0.99*-1.5`|`r (1-.99^2)`|
| 10000 | 0.99 | -1.5 | `r r_means[[23]]` | `r r_sds[[23]]` |`r 0.99*-1.5`|`r (1-.99^2)`|
| 200 | 0.99 | 1.5 | `r r_means[[25]]` | `r r_sds[[25]]` |`r 0.99*1.5`|`r (1-.99^2)`|
| 500 | 0.99 | 1.5 | `r r_means[[27]]` | `r r_sds[[27]]` |`r 0.99*1.5`|`r (1-.99^2)`|
| 5000 | 0.99 | 1.5 | `r r_means[[29]]` | `r r_sds[[29]]` |`r 0.99*1.5`|`r (1-.99^2)`|
| 10000 | 0.99 | 1.5 | `r r_means[[31]]` | `r r_sds[[31]]` |`r 0.99*1.5`|`r (1-.99^2)`|
